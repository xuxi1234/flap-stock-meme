...
files.push({file:'vercel.json',data:JSON.stringify({buildCommand:'NFT_ASSET_BASE_URL=https://flap-stock-butterfly-7777.vercel.app/nft npm run build:nft',outputDirectory:'dist',headers:[{source:'/nft/(.*)',headers:[{key:'Access-Control-Allow-Origin',value:'*'},{key:'Cache-Control',value:'public, max-age=3600'}]}]})});
