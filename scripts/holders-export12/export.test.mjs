...
const make=(token,addresses)=>({token,snapshotBlock:100,snapshotHash:hash,totalSupply:'100',verifiedBalanceSum:'100',coverageGap:'0',positiveHolders:addresses.length,creationBlock:90,logCount:2,ranges:[{from:90,to:100,count:2}],top:addresses.map((address,i)=>({address,rank:i+1,balance:String(100-i)}))});
