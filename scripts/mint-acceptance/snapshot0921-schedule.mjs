import { requireThat, BATCHES } from './snapshot0921-core.mjs';
export const AUTHORIZATION='snapshot0921x0.7777:200:3600seconds:budget0.3:lifetime';
...
export function authorize(j,env){
 requireThat(env.GITHUB_ACTIONS==='true'&&env.GITHUB_EVENT_NAME==='workflow_dispatch'&&env.GITHUB_REPOSITORY==='xuxi1234/flap-stock-meme'&&env.GITHUB_REF==='refs/heads/main'&&env.SNAPSHOT0921_CONFIRM==='snapshot0921x0.7777:200:3600seconds:budget0.3:lifetime','只允许用户在本仓库main手动确认固定名单、每批200地址、每60分钟一批和0.3 BNB累计预算后启动。');
