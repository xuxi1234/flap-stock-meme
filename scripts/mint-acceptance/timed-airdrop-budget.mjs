...
import { requireThat, equal, reserve } from './timed-airdrop-core.mjs';
...
export const CHARGED_BASELINE=43772162469141262n;
export const RAW_BASELINE=117757704722635913n;
