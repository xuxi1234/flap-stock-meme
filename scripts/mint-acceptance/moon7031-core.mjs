...
export const SOURCE_SHA='f1abf8c7e93dd66467f07489e519a5f706899bb0a1126da136df67fedc5a3970';
export const AMOUNT=10n**18n,INTERVAL=300,BATCHES=36,TOTAL=7031n*AMOUNT;
export const CONFIRM='moon7031:1:200:300seconds';
...
requireThat(addresses.length===7031&&new Set(addresses.map(a=>a.toLowerCase())).size===7031&&addresses.every(a=>isAddress(a)),'固定名单不符。');
...
export const ID=keccak256(toHex('moon7031:56:'+TOKEN+':'+ACCOUNT+':'+SOURCE_SHA+':1:300:v1'));
...
export function validate(j){
 ...
 requireThat(Array.isArray(j.entries)&&j.entries.length<=108,'交易记录异常。');
 let done=0;
