...
import { requireThat, equal, reserve } from './new72-core.mjs';
...
export const CAMPAIGN_GAS_CAP=100000000000000000n-CHARGED_BASELINE;
...
export function accountBudget(rows,confirmed=false){
 requireThat(confirmed===true,'请在手动运行入口明确确认：仅将已核实的旧钱包转回22914钱包的本金单独记账，Gas仍计入累计0.1 BNB；新任务Gas不得超出累计0.1 BNB的剩余额度。未确认时不执行。');
