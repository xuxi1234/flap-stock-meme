import { requireThat, BATCHES } from './image12-core.mjs';
export const AUTHORIZATION='image12x0.1:200:1800seconds:budget0.2:lifetime';
...
export function authorize(j,env){
 requireThat(env.GITHUB_ACTIONS==='true'&&env.GITHUB_EVENT_NAME==='workflow_dispatch'&&env.GITHUB_REPOSITORY==='xuxi1234/flap-stock-meme'&&env.GITHUB_REF==='refs/heads/main'&&env.IMAGE12_CONFIRM==='image12x0.1:200:1800seconds:budget0.2:lifetime','只允许用户在本仓库main手动确认固定名单、每批200地址、每30分钟一批和0.2 BNB累计预算后启动。');
