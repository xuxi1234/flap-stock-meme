...
export const BUDGET=300000000000000000n;
...
export function configure(source,sha,prior){
 ...
 ID=keccak256(toHex(`butterfly:56:74a7:snapshot0921:0.7777:3600seconds:${SOURCE_SHA}`));
}
...
export function reserve(spent,gas,price){
 ...
 requireThat(spent+fee<=BUDGET,'累计支出（含历史支出及 Gas）超过 0.3 BNB，停止。');return fee;
}
