...
export const SOURCE_SHA='e2b266ce9e55095e59fbafa5fd427f8e8f9ed5b79047665bcfd335898788fcf5';
export const AMOUNT=10n**18n,INTERVAL=1800,BATCHES=57,TOTAL=11323n*AMOUNT;
export const CONFIRM='moon11323:1:200:1800seconds';
const source=fs.readFileSync(new URL('./data/moon11323-recipients.txt',import.meta.url));
...
requireThat(addresses.length===11323&&new Set(addresses.map(a=>a.toLowerCase())).size===11323&&addresses.every(a=>isAddress(a)),'固定名单不符。');
...
export const ID=keccak256(toHex('moon11323:56:'+TOKEN+':'+ACCOUNT+':'+SOURCE_SHA+':1:1800:v1'));
