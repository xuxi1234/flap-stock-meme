    ...
    <section className="hero" aria-labelledby="hero-title">
      <div className="hero-copy">
        ...
        <div className="hero-description">
          ...
          <p>{language === 'zh' ? '蝴蝶股票是蝴蝶平台的第一个粉红锁仓分红机制➕蝴溢价出售机制' : '蝴蝶股票 is the first project on the Flap platform combining the Pink locked-token reward mechanism and the Butterfly premium-sale mechanism.'}</p>
          <p>{language === 'zh' ? <>结合<strong>金库、QQQB 奖励分配及代币销毁</strong>，探索社区参与、持有激励与流动性之间的协同，旨在改善短期博弈与长期参与动力不足等问题</> : <>Combining a <strong>treasury, QQQB reward distribution and token burning</strong>, the project explores how community participation, holding incentives and liquidity can work together, aiming to address short-term speculation and limited incentives for long-term participation.</>}</p>
