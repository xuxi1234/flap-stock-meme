    ...
    <section className="hero" aria-labelledby="hero-title">
      <div className="hero-copy">
        ...
        <div className="hero-description">
          ...
          <p className="hero-token-contract"><strong>{language === 'zh' ? '蝴蝶股票代币合约' : 'FLAP STOCK TOKEN CONTRACT'}</strong><br/><a href={`https://bscscan.com/token/${projectConfig.token.contractAddress}`} target="_blank" rel="noreferrer">{projectConfig.token.contractAddress}</a></p>
      ...
      <a className="hero-visual" href="#mechanism" aria-label={copy.brandSignalLabel}>
        ...
        <span className="hero-card-action">{copy.brandSignalLabel}</span>
      </a>
    </section>
  )
}
