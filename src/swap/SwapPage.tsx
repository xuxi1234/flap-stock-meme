...
import { ROUTER, TOKENS, STOCK_TOKENS, matchesToken, selectedStockToken, homeHref, tokenKey, type SwapToken } from './config'
...
export function SwapPage() {
  ...
  const [tokenCategory, setTokenCategory] = useState<'all' | 'stocks'>('all')
  ...
  const filteredTokens = [...TOKENS, ...customTokens].filter(t => matchesToken(t, search) && (tokenCategory === 'all' || !!t.stockSymbol))
