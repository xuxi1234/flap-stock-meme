...
contract ChangeFairies is ERC721, ReentrancyGuard, VRFV2PlusWrapperConsumerBase {
    ...
    uint256 public constant MAX_VRF_FEE = 0.0001 ether;
    ...
    constructor(string memory metadataBase, bytes32 manifest) ERC721("Chang'e Fairies", "CHANGE") VRFV2PlusWrapperConsumerBase(VRF_WRAPPER) {
